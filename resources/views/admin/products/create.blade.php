...
<div class="container py-4" style="max-width: 700px;">
    ...
    <div class="card shadow-sm border border-slate-200">
        <div class="card-header bg-white py-3">
            <h5 class="fw-bold text-dark mb-0" style="font-size: 1.05rem;"><i class="bi bi-plus-circle me-1 text-muted"></i> Formulir Tambah Produk Baru</h5>
        </div>
        <div class="card-body p-4">
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control" placeholder="Contoh: Nendoroid Gojo Satoru" required style="border-radius: 6px; font-size: 0.9rem;">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="price" id="price" value="{{ old('price') }}" min="0" class="form-control" placeholder="700000" required style="border-radius: 0 6px 6px 0; font-size: 0.9rem;">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12 mb-3">
                        ...
                        <input type="number" name="stock" id="stock" value="{{ old('stock') }}" min="0" class="form-control" placeholder="10" required style="border-radius: 6px; font-size: 0.9rem;">
                    </div>
                </div>

                <!-- Product Image -->
                <div class="mb-3">
                    <label for="image" class="form-label fw-semibold text-dark" style="font-size: 0.85rem;">Unggah Gambar Produk</label>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="5" class="form-control" placeholder="Tuliskan spesifikasi produk, produsen, ukuran, kondisi barang, dll secara lengkap." required style="border-radius: 6px; font-size: 0.9rem; resize: vertical;">{{ old('description') }}</textarea>
                </div>
